...
const ModaleRichiesta = ({
  ...
  const [showOpzioni, setShowOpzioni] = React.useState(false);
      ...
      <View style={stiliModaleRichiesta.sovrapposizione}>
        ...
        >
          ...
          >
              ...
              <Text
                ...
                style={
                  sottoTipo
                    ...
                    : stiliModaleRichiesta.stileSegnaposto
                }
              >
                {opzioniCorrente.find((o) => o.value === sottoTipo)?.label ??
                  "Seleziona..."}
              </Text>
            </TouchableOpacity>
            ...
            <TipoRichiestaModal
              visible={showOpzioni}
              options={opzioniCorrente}
              onClose={() => setShowOpzioni(false)}
              onSelect={(opt) => {
                impostaSottoTipo(opt.value);
                const parsed = Number(opt.value);
                impostaIdTipoRichiesta(Number.isNaN(parsed) ? null : parsed);
                setShowOpzioni(false);
              }}
            />
